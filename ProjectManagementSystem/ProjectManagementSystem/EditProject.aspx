...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="scripts/EditProject.js?v=7"></script>
    ...
    <div class="content-wrapper" style="background-color: #fff;">
        <asp:HiddenField ID="hdnUsersWithAccess" runat="server" />
        <!-- Content Header (Page header) -->
        <section class="content-header page_titleborder">
            <h1>Edit Project Details
            </h1>
            <ol class="breadcrumb">
                            ...
                            <div class="panel-heading option_navnew">
                                <span class="pull-left">
                                    ...
                                    <ul class="nav panel-tabs">
                                        <li id="liPersonal" ><a href="#tab1" data-toggle="tab"><i class="fa fa-user"></i>Project Details</a></li>
                                        ...
                                        <li id="liCourse" class="active"><a href="#tab4" data-toggle="tab"><i class="fa fa-graduation-cap"></i>Task Details</a></li>
                                    </ul>
                                </span>
                                        ...
                                        <div class="box-header with-border">
                                            ...
                                            <div class="col-md-6 form_cols">
                                                <div  style="display:none;" class="form-group">
                                                    ...
                                                    <label style="width: 100px;" class="radio-inline">
                                                        <input name="hdnProject" id="rbtnHdnNo" value="no" type="radio" />No
                                                    </label>
                                                </div>
                                            ...
                                            <div class="col-md-6 form_cols">
                                                <div class="form-group">
                                                    ...
                                                    <input id="txtAddProjectStartDate" class="form-control"></input>
                                                </div>
                                                <div class="form-group">
                                                    <label>Project End Date:</label>
                                                    <input id="txtEndDate" class="form-control"></input>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="col-md-6 bottom_button">
                                                <a href="#" onclick="return MarkAsCompleted();" class="btn btn-block btn-success pull-right" style="width: 49%;">Mark As Completed</a>
                                            </div>
                                    ...
                                    <div class="tab-pane active" id="tab4">
                                        <div class="row">
                                            ...
                                            <div style="margin-top: 50px;" class="col-md-12">
                                                <div class="col-md-6 pull-right bottom_button">
                                                    <a onclick="return SaveEditProject();" href="#tab4" class="btn btn-block btn-success pull-right" style="width: 49%;" data-toggle="tab">Save</a>
                                                    <button class="btn btn-block btn-warning pull-right" style="width: 49%; margin-top: 0px; margin-right: 2%;">Clear</button>
                                                </div>
                                            </div>
                                        </div>
