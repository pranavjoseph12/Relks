...
namespace BusinessLayer
{
    ...
    {
        public bool AddEnquiry(string name, string number, string address, string email, string response, string nextFollowDate, string comments, string userId, string customerId, string courseId)
        {
            EnquiryDataAccess obj = new EnquiryDataAccess();
            var result = obj.AddEnquiry(name, number, address, email, response, nextFollowDate, comments, userId, customerId, courseId);
            return result;
        }

        public List<EnquiryModel> GetAllEnquiries(string enquiryType, int pageNumber, string searchTerm, int numberOfRecords, string fromDate, string toDate,string centerId)
        {
            EnquiryDataAccess obj = new EnquiryDataAccess();
            var result = obj.GetAllEnquiries(enquiryType, pageNumber, searchTerm, numberOfRecords,fromDate,toDate, centerId);
        ...
        public byte[] GetEnquiryExcel(string enquiryType, int pageNumber, string searchTerm, int numberOfRecords, string fromDate, string toDate,string centerId)
        {
            EnquiryDataAccess obj = new EnquiryDataAccess();
            var result = obj.GetAllEnquiries(enquiryType, 1, searchTerm, 10000, fromDate, toDate, centerId);
