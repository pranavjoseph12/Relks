<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddRole.aspx.cs" Inherits="ProjectManagementSystem.AddRole" %>
                    ...
                    <div class="box box-default">
                        ...
                        <asp:CheckBox ID="chkUserAccessProjectDelete" name="optionAssignUserProject" runat="server"></asp:CheckBox>
                                            ...
                                            <tr>
                                                <td>Income </td>
                                                <td>View
                        <asp:CheckBox ID="chkIncomeView" name="optionIncome" runat="server"></asp:CheckBox>
                                                </td>
                                                <td>Add/Edit
                        <asp:CheckBox ID="chkIncomeEdit" name="optionIncome" runat="server"></asp:CheckBox>
                                                </td>
                                                <td>Delete
                        <asp:CheckBox ID="chkIncomeDelete" name="optionIncome" runat="server"></asp:CheckBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Quotation</td>
                                                <td>View
                        <asp:CheckBox ID="chkQuotationView" name="optionQuotation" runat="server"></asp:CheckBox>
                                                </td>
                                                <td>Add/Edit
                        <asp:CheckBox ID="chkQuotationEdit" name="optionQuotation" runat="server"></asp:CheckBox>
                                                </td>
                                                <td>Delete
                        <asp:CheckBox ID="chkQuotationDelete" name="optionQuotation" runat="server"></asp:CheckBox>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="col-md-6 pull-right">
                                <asp:Button ID="btnAdd" OnClientClick="return ValidatePage();" runat="server" class="btn btn-block btn-success pull-right" Style="width: 49%;" type="button" Text="Add Role" value="Submit" OnClick="btnAdd_Click" />
