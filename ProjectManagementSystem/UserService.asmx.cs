...
namespace ProjectManagementSystem
{
    ...
    public class UserService : System.Web.Services.WebService
    {
        ...
        public string AddUser(string name, string phone, string email, string password, string role, string allowAssignTask,string userId)
        {
            ...
            var result = obj.AddUser(name, phone, email, password, role, userID, allowAssignTask,userId);
