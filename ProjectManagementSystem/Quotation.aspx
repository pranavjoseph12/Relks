                        ...
                        <div class="panel-heading option_navnew">
                            <span class="pull-left">
                                ...
                                <ul class="nav panel-tabs">
                                    <li id="liViewQuotation" class="active"><a href="#tab1" data-toggle="tab"><i class="fa fa-user"></i>View</a></li>
                                    <li id="liCreateQuotation"><a href="#tab2" data-toggle="tab"><i class="fa fa-user"></i>Create</a></li>
                                    <li id="liViewItem"><a href="#tab3" data-toggle="tab"><i class="fa fa-user"></i>Add Item</a></li>
                                    <li id="liAddItem"><a href="#tab4" data-toggle="tab"><i class="fa fa-user"></i>View Item</a></li>
                                </ul>
                            </span>
                            ...
                            <div class="col-md-12" style="background-color: #fff;">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab1">
                                        ...
                                        <div class="box-header with-border" id="divQuotViewContent">
                                            ...
                                            <div class="data_cont_box">
                                                ...
                                                <div id="example1_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                                    ...
                                                    <table id="tblViewQuotation" class="table table-bordered table-striped dataTable">
                                                        <thead>
                                                            <tr role="row">
                                                                ...
                                                                <th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Joined Student"></th>
                                                            </tr>
                                                        </thead>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-6">
                                                            <div class="dataTables_info" id="divCountQuotation">Showing 1 to 3 of 3 entries</div>
                                                        </div>
                                                        <div class="col-xs-6">
                                                            <div id="divPaginationQuotation" class="dataTables_paginate paging_bootstrap">
                                    ...
                                    <div class="tab-pane" id="tab3">
                                       ...
                                       <div class="tab-pane" id="tab4">
                                        <h4>View Items</h4>
                                        <div class="box-header with-border" id="divItemViewContent">

                                            <div class="data_cont_box">

                                                <div id="example1_wrapper1" class="dataTables_wrapper form-inline" role="grid">
                                                    <div class="row">
                                                        <div class="col-xs-12">
                                                            <div class="dataTables_filter" id="example1_filter1">
                                                                <label class="pull-left">

                                                                    <input placeholder="Item Name" aria-controls="example1" type="text" id="txtItem">
                                                                    <button style="border: none; border-radius: 3px;" id="btnItemSearch" class="btn-primary">Search</button>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <table id="tblViewItem" class="table table-bordered table-striped dataTable">
                                                        <thead>
                                                            <tr role="row">
                                                                <th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="End Date">Item Name</th>
                                                                <th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Allocated Students">Combo Item</th>
                                                                <th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Joined Student">Unit</th>
                                                                <th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Joined Student">Unit Rate</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-6">
                                                            <div class="dataTables_info" id="divCountItem">Showing 1 to 3 of 3 entries</div>
                                                        </div>
                                                        <div class="col-xs-6">
                                                            <div id="divPaginationItem" class="dataTables_paginate paging_bootstrap">
                                                                <ul class="pagination pull-right">
                                                                    <li class="prev disabled"><a href="#">← Previous</a></li>
                                                                    <li class="next disabled"><a href="#">Next → </a></li>
                                                                </ul>
